        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={12}>
            ...
            <Card className="p-2 mb-4">
              <Grid container>
                <Grid item xs={9} md={9} className="d-flex flex-row align-items-center">
                  <Logo className="me-3" src={'https://avatars.slack-edge.com/2019-08-29/730880231907_caa71cf812305a064114_512.png'} />
                  <div className="d-flex flex-column justify-content-center">
              ...
              <Grid container>
                <Grid item xs={9} md={9} className="d-flex flex-row align-items-center">
                  ...
                  <div className="d-flex flex-column justify-content-center">
                    ...
                    <Typography variant="p1">Email and SMS marketing for growing ecommerce brands.</Typography>
                  </div>
                </Grid>
                <Grid item xs={3} md={3} className="d-flex flex-row align-items-center justify-content-end">
                  <Button variant="outlined" className="me-3">
              ...
              <Grid container>
                <Grid item xs={9} md={9} className="d-flex flex-row align-items-center">
                  ...
                  <div className="d-flex flex-column justify-content-center">
                    ...
                    <Typography variant="p1">Allow your customers to talk to you directly through WhatsApp</Typography>
                  </div>
                </Grid>
                <Grid item xs={3} md={3} className="d-flex flex-row align-items-center justify-content-end">
                  <Button variant="outlined" className="me-3">
            ...
            <Card className="p-2 mb-4">
              <Grid container>
                <Grid item xs={9} md={9} className="d-flex flex-row align-items-center">
                  <Logo
                    className="me-3"
                    src={'https://qph.fs.quoracdn.net/main-qimg-4f15d8c9e38363aa8a518a834d8f733a'}
                  />
                  <div className="d-flex flex-column justify-content-center">
            ...
            <Card className="p-2 mb-4">
              <Grid container>
                <Grid item xs={9} md={9} className="d-flex flex-row align-items-center">
                  <Logo className="me-3" src={'https://ps.w.org/hellobar/assets/icon-256x256.png?rev=1929259'} />
                  <div className="d-flex flex-column justify-content-center">
