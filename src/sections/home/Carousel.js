...
export default function SimpleSlider() {
  ...
  const images = [
      ...
      {url: 'https://qwikshop.s3.ap-south-1.amazonaws.com/Carousel/Carousel/Group+14.png', title: 'Sell Clothes Online'},
      {url: 'https://qwikshop.s3.ap-south-1.amazonaws.com/Carousel/Carousel/Group+15.png', title: 'Sell Art Online',},
      {url: 'https://qwikshop.s3.ap-south-1.amazonaws.com/Carousel/Carousel/Group+16.png', title: 'Sell Grocery Online',},
      {url: 'https://qwikshop.s3.ap-south-1.amazonaws.com/Carousel/Carousel/Group+17.png', title: 'Sell Mobile Online',},
    {url: 'https://qwikshop.s3.ap-south-1.amazonaws.com/Carousel/Carousel/Group+18.png', title: 'Sell Furniture Online',},
  ];

  return (
    <Slider {...settings}>
        {images.map((el) => <Card key={el.title} sx={{ p: 2, m: 3, }}>{/*  */}
            
            <img style={{height: '260px', objectFit: 'contain'}} src={el.url} alt="seller" />
            <Typography sx={{mt:2}} variant="subtitle1" >{el.title}</Typography>
            </Card>)}
