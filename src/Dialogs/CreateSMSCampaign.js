...
const steps = ['Enter Campaign Name', 'Select Message', 'Select Audience', 'Preview Campaign', 'Pay and launch'];
                            ...
                            renderOption={(props, option, { selected }) => (
                              <Box component="li" sx={{ '& > img': { mr: 2, flexShrink: 0 } }} {...props}>
                                <li {...props}>
                                 ...
                                 <Typography variant="subtitle1">{option.label} ({option.mobile})</Typography>  <Typography variant="subtitle2"> Total orders:{'  '}
                                  {option.totalOrders}</Typography>  <Typography variant="subtitle2">Total Sales(Rs.): {option.totalSales} <br />{' '}</Typography> 
